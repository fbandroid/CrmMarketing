...
public class SalesExecutiveListAdapter extends RecyclerView.Adapter<SalesExecutiveListAdapter.ViewHolder> {
     ...
     */
    public SalesExecutiveListAdapter(ArrayList<User> dataSet, Context context) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        viewHolder.getTvEmpid().setText(mDataSet.get(position).getUContact());
