...
public class OperationExFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_op_dashboard, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        cvViewTarget.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                addFragment(new ViewCallLogFragment(), OperationExFragment.this);
            }
        });
        ...
        cvInquirylist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(inquiryListInfoFragment, OperationExFragment.this);
                } else {
        ...
        cvViewTarget.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(viewTargetFragment, OperationExFragment.this);
                } else {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    ...
                    if (Utils.isLocationEnabled(getActivity())) {
                        addFragment(attandaceMasterFragment, OperationExFragment.this);
        ...
        fragmentTlDashboardCvEventAttendance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(eventAttendanceFragment, OperationExFragment.this);
                } else {
        ...
        fragmentTlDashboardCvExpence.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(expenseRequestFragment, OperationExFragment.this);
                } else {
        ...
        fragmentAdminDashboardCvRequestLeave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(requestLeaveFragment, OperationExFragment.this);
                } else {
        ...
        fragmentTlDashboardCvClient.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(clientListFragment, OperationExFragment.this);
                } else {
        ...
        fragmentAdminDashboardCvEventReport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(eventReportFragment, OperationExFragment.this);
                } else {
        ...
        fragmentAdminDashboardCvApproveLeave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(approveLeaveFragment, OperationExFragment.this);
                } else {
