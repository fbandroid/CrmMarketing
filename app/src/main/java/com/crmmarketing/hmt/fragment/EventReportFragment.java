...
public class EventReportFragment extends Fragment {
    ...
    private RetrofitClient.EventReport eventReport;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        eventReport = RetrofitClient.eventReport(Constants.BASE_URL);
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ((HomeActivity) context).setTitle("Event Report");
        return inflater.inflate(R.layout.fragment_event_report, container, false);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        recyclerView = (RecyclerView) view.findViewById(R.id.rvEventReport);
        ...
        eventReport.getEventReport().enqueue(new Callback<EventList>() {
            @Override
            public void onResponse(Call<EventList> call, Response<EventList> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    final ArrayList<Event> eventArrayList = (ArrayList<Event>) response.body().getEvents();

                    if (eventArrayList.size() > 0) {

                        final CustomAdapter customAdapter = new CustomAdapter(eventArrayList);
            ...
            public ViewHolder(View v) {
                ...
                v.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Fragment fragment = new InvitedCustomerFragment();
                        ...
                        addFragment(fragment, EventReportFragment.this);
