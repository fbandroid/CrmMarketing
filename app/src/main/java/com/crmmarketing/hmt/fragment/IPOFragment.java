...
public class IPOFragment extends Fragment implements SearchView.OnQueryTextListener {
...
//            dob = sdf.format(endCalender.getTime());
            ...
            volumedata.getVolumeData(id, role, "8", sdf.format(endCalender.getTime()))
                        ...
                        public void onResponse(Call<VolumeData> call, Response<VolumeData> response) {
                            ...
                            if (response.isSuccessful()) {
                                ...
                                if (datumArrayList.size() > 0) {
                                    ...
                                    customAdapter = new CustomAdapter(datumArrayList, getActivity(), 8,role);
