...
public class MiniAdminDashboard extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        fragmentAdminDashboardCvApproveLeave.setVisibility(View.VISIBLE);
        ...
        cvInquiryList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(inquiryListInfoFragment, MiniAdminDashboard.this);
                } else {
        ...
        cvTodaysInquiry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(todaysFollowUpFragment, MiniAdminDashboard.this);
                } else {
        ...
        cvCompletedInquiry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(completedFollowUpListFragment, MiniAdminDashboard.this);
                } else {
        ...
        cvViewTarget.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(viewTargetFragment, MiniAdminDashboard.this);
                } else {
        ...
        cvEmpList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(new ListOfTeamLeaderFragment(), MiniAdminDashboard.this);
                } else {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    ...
                    if (Utils.isLocationEnabled(getActivity())) {
                        addFragment(attandaceMasterFragment, MiniAdminDashboard.this);
        ...
        cvChecklist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(checkListFragment, MiniAdminDashboard.this);
                } else {
        ...
        fragmentAdminDashboardCvClient.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(clientListFragment, MiniAdminDashboard.this);
                } else {
        ...
        fragmentTlDashboardCvEventAttendance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(eventAttendanceFragment, MiniAdminDashboard.this);
                } else {
        ...
        fragmentTlDashboardCvExpence.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(expenseRequestFragment, MiniAdminDashboard.this);
                } else {
        ...
        fragmentAdminDashboardCvRequestLeave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(requestLeaveFragment, MiniAdminDashboard.this);
                } else {
        ...
        fragmentAdminDashboardCvEventReport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(eventReportFragment, MiniAdminDashboard.this);
                } else {
        ...
        fragmentAdminDashboardCvApproveLeave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (isDoubleClick()) {
                    return;
                ...
                bundle11.putString("id", id);
                approveLeaveFragment.setArguments(bundle11);
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(approveLeaveFragment, MiniAdminDashboard.this);
                } else {
