...
import com.crmmarketing.hmt.ViewVolumeDetailActivity;
import com.crmmarketing.hmt.adapter.CustomAdapter;
import com.crmmarketing.hmt.adapter.OnVolumeReportClickListener;
...
public class CrDataFragment extends Fragment implements SearchView.OnQueryTextListener {
...
//            dob = sdf.format(endCalender.getTime());
            ...
            volumedata.getVolumeData(id, role, "11", sdf.format(endCalender.getTime()))
                        ...
                        public void onResponse(Call<VolumeData> call, Response<VolumeData> response) {
                            ...
                            if (response.isSuccessful()) {
                                ...
                                if (datumArrayList != null && datumArrayList.size() > 0) {
                                    ...
                                    customAdapter = new CustomAdapter(datumArrayList, getActivity(), 11, role);
                                    rvFNO.setAdapter(customAdapter);
                                    customAdapter.setOnVolumeClickListener(new OnVolumeReportClickListener() {
                                        @Override
                                        public void onVolumeClick(Datum datum) {

                                            Intent intent = new Intent(getActivity(), ViewVolumeDetailActivity.class);
