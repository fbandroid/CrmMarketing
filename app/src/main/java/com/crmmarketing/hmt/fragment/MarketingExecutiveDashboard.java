...
public class MarketingExecutiveDashboard extends Fragment {
    ...
    private CardView fragmentMeDashboardCvVolume;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        cvAddentance = (CardView) view.findViewById(R.id.fragment_me_dashboard_cvAttendance);
        ...
        fragmentMeDashboardCvVolume = (CardView) view.findViewById(R.id.fragment_me_dashboard_cvVolume);
        fragmentMeDashboardCvVolume.setVisibility(View.GONE);
        ...
        cvViewTarget.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                addFragment(new ViewCallLogFragment(), MarketingExecutiveDashboard.this);
            }
        });
        ...
        cvInquirylist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(inquiryListInfoFragment, MarketingExecutiveDashboard.this);
                } else {
        ...
        cvTodaysInquiry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(todaysFollowUpFragment, MarketingExecutiveDashboard.this);
                } else {
        ...
        cvCompletedInquiry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(completedFollowUpListFragment, MarketingExecutiveDashboard.this);
                } else {
        ...
        cvViewTarget.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(viewTargetFragment, MarketingExecutiveDashboard.this);
                } else {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    ...
                    if (Utils.isLocationEnabled(getActivity())) {
                        addFragment(attandaceMasterFragment, MarketingExecutiveDashboard.this);
        ...
        cvCheckList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(checkListFragment, MarketingExecutiveDashboard.this);
                } else {
        ...
        fragmentTlDashboardCvEventAttendance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(eventAttendanceFragment, MarketingExecutiveDashboard.this);
                } else {
        ...
        fragmentTlDashboardCvExpence.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(expenseRequestFragment, MarketingExecutiveDashboard.this);
                } else {
        ...
        fragmentMeDashboardCvVolume.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (isDoubleClick()) {
                    return;
        ...
        fragmentAdminDashboardCvRequestLeave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(requestLeaveFragment, MarketingExecutiveDashboard.this);
                } else {
        ...
        fragmentTlDashboardCvClient.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(clientListFragment, MarketingExecutiveDashboard.this);
                } else {
        ...
        fragmentAdminDashboardCvEventReport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(eventReportFragment, MarketingExecutiveDashboard.this);
                } else {
