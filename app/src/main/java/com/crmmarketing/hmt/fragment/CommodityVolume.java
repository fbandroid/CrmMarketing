...
public class CommodityVolume extends Fragment implements SearchView.OnQueryTextListener{
...
//            dob = sdf.format(endCalender.getTime());
            ...
            volumedata.getVolumeData(id, role, "3", sdf.format(endCalender.getTime()))
                        ...
                        public void onResponse(Call<VolumeData> call, Response<VolumeData> response) {
                            ...
                            if (response.isSuccessful()) {
                                ...
                                if (datumArrayList.size() > 0) {
                                    ...
                                    customAdapter = new CustomAdapter(datumArrayList, getActivity(), 3,role);
    ...
    public boolean onQueryTextSubmit(String query) {
        if (customAdapter != null)
            customAdapter.setFilter(filter(datumArrayList, query));
