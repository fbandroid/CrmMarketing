...
public class OperationMEFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_op_me, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        cvViewTarget.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                addFragment(new ViewCallLogFragment(), OperationMEFragment.this);
            }
        });
        ...
        cvInquirylist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(inquiryListInfoFragment, OperationMEFragment.this);
                } else {
        ...
        cvViewTarget.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(viewTargetFragment, OperationMEFragment.this);
                } else {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    ...
                    if (Utils.isLocationEnabled(getActivity())) {
                        addFragment(attandaceMasterFragment, OperationMEFragment.this);
        ...
        fragmentTlDashboardCvEventAttendance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(eventAttendanceFragment, OperationMEFragment.this);
                } else {
        ...
        fragmentTlDashboardCvExpence.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(expenseRequestFragment, OperationMEFragment.this);
                } else {
        ...
        fragmentAdminDashboardCvRequestLeave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(requestLeaveFragment, OperationMEFragment.this);
                } else {
        ...
        fragmentTlDashboardCvClient.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(clientListFragment, OperationMEFragment.this);
                } else {
        ...
        fragmentAdminDashboardCvEventReport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.checkInternetConnection(getActivity())) {
                    addFragment(eventReportFragment, OperationMEFragment.this);
                } else {
